...
async def repeat_until_demo():
    ...
    while True:
        ...
        # Repeat Until - Keep Doing Something Until a Condition is Met
        while is_near(): # WITH parentheses - check right now!
                         # This means:
                         #    "Check right now"
