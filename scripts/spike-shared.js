...
while not (#<your condition or function here>)`
    ...
    while True:
        if button.pressed(button.LEFT):
            await when_left_button_pressed_lower_and_raise_the_arm()
            break
        sleep_ms(50)
`
                },
                {
                    id: 'event6',
                    buttonText: 'When right button pressed',
                    emoji: ICON_FORCE_SENSOR,
                    color: '#FFD700',
                    textPython: `
    while True:
        if button.pressed(button.RIGHT):
            await when_right_button_pressed_detect_blue_line()
            break
        sleep_ms(50)
`
                },
            ...
            snippets: [
                {
                    ...
                    emoji: '🧿',
                    color: '#CC0000',
                    textPython: buildGettingStartedPython('Robot Shuffle')
                },
                {
                    id: 'gettingstarted2',
                    ...
                    emoji: '🧿',
                    color: '#CC0000',
                    textPython: buildGettingStartedPython('Round the Garage')
                },
                {
                    id: 'gettingstarted3',
                    ...
                    emoji: '🧿',
                    color: '#CC0000',
                    textPython: buildGettingStartedPython('Hay Bale')
                },
                {
                    id: 'gettingstarted4',
